...
public class ChangePageOne extends Activity {

    //TODO：过场一，狗子安上了集成电路芯片
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_page_one);
        handler = new Handler();
        dog = findViewById(R.id.imageView3);
        hand = findViewById(R.id.imageView4);
        movingEffect();
        final ObjectAnimator dogmove_1 = ObjectAnimator.ofFloat(dog,"translationX",-80,800);
    ...
    public void next(View view) {
        ...
        next.setClass(this, GameTwo.class);
        startActivity(next);
